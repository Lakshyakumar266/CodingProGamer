...
function ListProject(props) {
  ...
  return (
    <>
      <div className="m-2">
        <h1 className="text-2xl dark:text-gray-200 mb-4">Created Projects</h1>
        <div className="p-4">
              ...
              <>
                <Header className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                  <HeaderRow>
                    ...
                    <HeaderCell scope="col" className="!px-6 !py-3 !bg-gray-50 dark:!bg-gray-700">Content</HeaderCell>
                    <HeaderCell scope="col" className="!px-6 !py-3 !bg-gray-50 dark:!bg-gray-700">Links</HeaderCell>
